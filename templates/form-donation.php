...
// Get campaign data
$campaign_id = isset($_GET['campaign_id']) ? intval($_GET['campaign_id']) : get_the_ID();
...
// Enqueue styles and scripts inline for this template
?>
...
<style>
    ...
    /* ===== Container ===== */
    .donation-form-wrapper .donation__container,
    .donation-form-wrapper .payment-method__container,
    .donation-form-wrapper .user-info__container {
        max-width: 48rem;
        margin: 2.5rem auto;
    ...
    /* ===== Banner / Gambar ===== */
    .donation-form-wrapper .donation__intro img {
        width: 100%;
        height: auto;
    ...
    .donation-form-wrapper .campaign-info {
        background: #f8f9fa;
        padding: 15px;
        border-radius: 8px;
        margin-bottom: 25px;
    ...
    .donation-form-wrapper .campaign-info .label {
        font-weight: 600;
        color: #666;
    }

    .donation-form-wrapper .campaign-info .value {
        font-weight: bold;
        color: #2c3e50;
    }

    /* ===== Heading & Note ===== */
    .donation-form-wrapper .donation__note,
    .donation-form-wrapper .payment-method__note,
    .donation-form-wrapper .user-info__note {
        font-size: 0.875rem;
        margin-bottom: 1.25rem;
        color: #555;
    }

    .donation-form-wrapper .donation__heading,
    .donation-form-wrapper .payment-method__heading,
    .donation-form-wrapper .user-info__heading {
        font-size: 1.125rem;
        font-weight: bold;
        margin-bottom: 1.25rem;
    }
    ...
    /* ===== Bank Transfer Info ===== */
    .donation-form-wrapper .bank-transfer-info {
        display: flex;
        align-items: center;
        gap: 15px;
        margin-bottom: 20px;
    ...
    .donation-form-wrapper .bank-transfer-info:hover {
        border-color: #13723b;
        background-color: #f8f9fa;
    }

    .donation-form-wrapper .bank-transfer-info.selected {
        border-color: #13723b;
        background-color: #f0f8f4;
    }

    .donation-form-wrapper .bank-transfer-info .bank-logo {
        flex-shrink: 0;
    }

    .donation-form-wrapper .bank-transfer-info .bank-text {
        line-height: 1.4;
        font-size: 0.9rem;
    }

    .donation-form-wrapper .selectable {
        cursor: pointer;
    }

    /* ===== Opsi Nominal ===== */
    .donation-form-wrapper .donation__options {
        display: grid;
    ...
    .donation-form-wrapper .donation__button {
        padding: 0.75rem;
    ...
    .donation-form-wrapper .donation__button:hover {
        border-color: #13723b;
        background-color: #f8f9fa;
    }

    .donation-form-wrapper .donation__button.selected {
        background-color: transparent;
        color: #13723b;
        border-color: #13723b;
    }
    ...
    /* ===== Form Fields ===== */
    .donation-form-wrapper .form__group {
        margin-bottom: 1.25rem;
    }

    .donation-form-wrapper .form__label {
        display: block;
        font-weight: bold;
    ...
    .donation-form-wrapper .form__required {
        color: red;
    }

    .donation-form-wrapper .form__desc {
        font-size: 0.8125rem;
        font-style: italic;
        color: #666;
        margin-top: 0.5rem;
    ...
    .donation-form-wrapper input[type="text"]:focus,
    .donation-form-wrapper input[type="email"]:focus,
    .donation-form-wrapper input[type="tel"]:focus,
    .donation-form-wrapper input[type="number"]:focus,
    ...
    /* ===== Form Check ===== */
    .donation-form-wrapper .form__check {
        display: flex;
        align-items: center;
        gap: 10px;
        margin-bottom: 1rem;
    ...
    .donation-form-wrapper .form__check input[type="checkbox"] {
        width: 18px;
        height: 18px;
        cursor: pointer;
    }

    .donation-form-wrapper .form__check label {
        cursor: pointer;
        font-size: 0.875rem;
        line-height: 1.4;
    }

    .donation-form-wrapper .form__check label a {
        color: #13723b;
        text-decoration: none;
    }

    .donation-form-wrapper .form__check label a:hover {
        text-decoration: underline;
    }

    /* ===== Error Messages ===== */
    .donation-form-wrapper .form-messages {
        margin-top: 20px;
        padding: 15px;
        border-radius: 8px;
        display: none;
    ...
    .donation-form-wrapper .form-messages.success {
        background: #d4edda;
        color: #155724;
    ...
    .donation-form-wrapper .form-messages.error {
        background: #f8d7da;
        color: #721c24;
    ...
    .donation-form-wrapper .donation-form-inactive,
    .donation-form-wrapper .error {
        text-align: center;
        padding: 30px;
        background: #f8d7da;
        color: #721c24;
    ...
    /* ===== Sticky Donation Bar ===== */
    .donation-form-wrapper .donation-sticky {
        position: sticky;
        bottom: 0;
        width: 100%;
        background-color: #ffffff;
    ...
    .donation-form-wrapper .donation-sticky__content {
        max-width: 48rem;
        margin: 0 auto;
        display: flex;
        align-items: center;
    ...
    .donation-form-wrapper .donation-sticky__label {
        font-size: 0.875rem;
        color: #555;
    }

    .donation-form-wrapper .donation-sticky__amount {
        font-size: 1.5rem;
        font-weight: 1000;
        color: #13723b;
    }

    .donation-form-wrapper .donation-sticky__button {
    ...
    .donation-form-wrapper .donation-sticky__button:hover {
        background-color: #0e522a;
    }

    .donation-form-wrapper .donation-sticky__button:disabled {
        background-color: #bdc3c7;
        cursor: not-allowed;
    }

    .donation-form-wrapper .btn-loading {
        display: none;
    }

    .donation-form-wrapper .spinner {
    ...
    @media (max-width: 768px) {
        ...
        .donation-form-wrapper .donation-sticky__summary {
            flex: 1 1 50%;
            min-width: 9.375rem;
        }
